...
namespace DialogueSystem.Runtime.Narration
{
    ...
    {
        public List<MessageData> Dialogue { get; }
        ...
        public NarrativeNode(List<MessageData> dialogue, string nodeId, bool isCheckpoint = false, NarrativeNode defaultPath = null)
        {
            Dialogue = dialogue;
            NodeId = nodeId;
        ...
        public NarrativeNode(List<MessageData> dialogue, string nodeId, bool disableAlreadyChosenOptions = false)
        {
            Dialogue = dialogue;
            NodeId = nodeId;
            DefaultPath = null;
